...
const ConsoleOutput = forwardRef<HTMLDivElement, ConsoleOutputProps>(({
  ...
  const cardAccepted =
    "bg-black border border-white/10 dark:from-green-900/40 dark:to-green-800/60 border-green-200 dark:border-green-700";
  const cardRejected =
    "bg-black border border-white/10 dark:from-red-900/40 dark:to-red-800/60 border-red-200 dark:border-red-700";
  const tabActive =
    "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-semibold border-blue-400 dark:border-blue-500";
  const tabInactive =
    "bg-transparent text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-black border-transparent";

  return (
    <div
      ref={ref}
      className="bg-white dark:bg-black flex flex-col border-t border-gray-200 dark:border-gray-800"
      style={{
    ...
    >
      {/* Header */}
      <div className="px-5 py-2 border-b border-gray-200 dark:border-gray-800 bg-gray-50/90 dark:bg-black/90 backdrop-blur flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="p-1.5 hover:bg-gray-200 dark:hover:bg-black rounded-md transition-colors text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"
      ...
      {isExpanded && (
        <div
          ref={consoleRef}
          className="flex-1 px-8 py-6 overflow-y-auto bg-white dark:bg-black transition-all duration-300 ease-in-out scrollbar-smooth"
          style={{
            minHeight: '240px',
            width: '100%',
            ...
            <div>
              <div className="flex space-x-2 mb-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg border text-sm transition-all duration-150 ${
                      activeTestCaseTab === idx
                        ...
                        : "bg-gray-50 dark:bg-black text-gray-500 dark:text-gray-400 border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
                    }`}
                  >
                    Case {idx + 1}
                  </button>
                ...
                {publicTestCases.length > 0 && (
                  <button className="px-4 py-2 rounded-lg border text-sm text-gray-400 dark:text-gray-500 cursor-not-allowed bg-gray-50 dark:bg-black border-gray-200 dark:border-gray-700">
                    <Plus className="w-4 h-4" />
                  </button>
                )}
              </div>
              {publicTestCases[activeTestCaseTab] ? (
                <div className={`${cardBase} bg-gray-50 dark:bg-black border-gray-200 dark:border-gray-700 p-6 mb-2`}>
                  <div className="mb-4">
              ...
              {submissionResult && (
                <div className={`p-6 mb-2 ${cardBase} ${submissionResult.status === "Accepted" ? cardAccepted : cardRejected}`}>
                  ...
                  {submissionResult.potd && submissionResult.potd.awarded && (
                    <div className="p-4 bg-black border border-white/10 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg mb-4">
...
//     <div 
//       ref={ref}
//       className="bg-white dark:bg-black flex flex-col border-t border-gray-200 dark:border-gray-700"
//       style={{ 
...
//     >
//       {/* Console Header */}
//       <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50/90 dark:bg-black/90 backdrop-blur-sm flex-shrink-0">
//         <div className="flex items-center justify-between">
...
//                   : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-black/50'
//               }`}
//             >
//               Test Cases
//             </button> */}
...
//                       <div 
//                         key={index} 
//                         className="bg-gray-50 dark:bg-black border border-gray-200 dark:border-gray-700 rounded-lg p-4"
//                       >
...
//                             <pre className="bg-white dark:bg-black p-3 rounded border border-gray-200 dark:border-gray-600 text-sm font-mono text-gray-800 dark:text-gray-200 overflow-x-auto">
//                               {testCase.input}
//                             </pre>
//                           </div>
//                           <div>
...
//                   <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black/50">
...
//                               ? 'border-blue-500 text-blue-600 dark:text-blue-400 bg-white dark:bg-black'
//                               : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-white/50 dark:hover:bg-black/50'
//                           } ${
//                             result.passed 
...
//                         <div className="bg-gray-50 dark:bg-black rounded-lg p-3 border border-gray-200 dark:border-gray-700">
//                           <pre className="text-sm font-mono text-gray-800 dark:text-gray-200 whitespace-pre-wrap">
//                             {runResult.testResults[activeTestCaseTab].input || 'No input data'}
//                           </pre>
//                         </div>
...
//               {submissionResult.potd && submissionResult.potd.awarded && (
//                 <div className="p-4 bg-black border border-white/10 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
//                   <div className="flex items-center">
//                     <div className="w-8 h-8 bg-yellow-400 dark:bg-yellow-500 rounded-full flex items-center justify-center text-white text-lg font-bold">
//                       
//                     </div>
...
//             <div className="space-y-4">
//               <div className="bg-white dark:bg-black rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
//                 {/* <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black/50"> */}
//                   {/* <div className="flex items-center space-x-2">
...
//                 <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black/30">
//                   <div className="flex overflow-x-auto">
