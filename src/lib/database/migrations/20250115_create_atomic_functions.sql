...
DROP FUNCTION IF EXISTS recalculate_user_stats(UUID) CASCADE;
DROP FUNCTION IF EXISTS record_submission_with_points(UUID, UUID, UUID, TEXT, TEXT, TEXT, NUMERIC, INTEGER, INTEGER, INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS update_problem_solved_count(UUID) CASCADE;
DROP FUNCTION IF EXISTS increment_user_streak(UUID) CASCADE;
DROP FUNCTION IF EXISTS award_points_for_solve(UUID, UUID, INTEGER) CASCADE;
